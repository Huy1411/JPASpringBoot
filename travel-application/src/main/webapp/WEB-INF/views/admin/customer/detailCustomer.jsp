                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>Status </td>
                                                        <td><c:if test="${detailCustomer.status ==1}">
                                                            <span class="badge badge-success">Show</span>
                                                        </c:if>
                                                            <c:if test="${detailCustomer.status ==2}">
                                                                <span class="badge badge-danger">Hidden</span>
                                                            </c:if>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <a href="${pageContext.request.contextPath}/admin/comments/editComment?id=${detailCustomer.customerId}"
