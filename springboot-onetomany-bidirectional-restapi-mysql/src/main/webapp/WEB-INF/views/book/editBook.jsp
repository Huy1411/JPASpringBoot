            ...
            <div class="col-md-5">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body" style="display: block;">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <%--@elvariable id="bookEdit" type=""--%>
                        <f:form action="${pageContext.request.contextPath}/book/updateBook" method="POST" modelAttribute="bookEdit">
                            <f:input path="id" type="hidden"/>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Book Name : </label>
                                <f:input path="name" type="text"  class="form-control ${param.errorbookname !=null ?'border border-danger':''}" id="exampleInputEmail1"  placeholder="Enter Book Name..."/>
